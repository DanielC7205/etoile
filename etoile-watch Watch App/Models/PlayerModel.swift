...
class PlayerModel {
    ...
    private func setupClient() async throws {
        if client == nil {
            ...
            let configuration = await JellyfinClient.Configuration(url: instance, client: "Etoile", deviceName: "Watch", deviceID: UUID().uuidString, version: Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? String ?? "")
